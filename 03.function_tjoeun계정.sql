...
SELECT EMP_NAME
    ...
    ,SUBSTR(EMP_NO, 3, 4)||'월' 생월
    ,SUBSTR(EMP_NO, 5, 6)||'일' 생일
FROM EMPLOYEE;
...
SELECT EMP_NAME, DEPT_CODE, TO_DATE(SUBSTR(EMP_NO, 1, 6), 'RRMMDD') 생년월일, TO_DATE( (SUBSTR(EMP_NO, 1, 2)), 'RR') 나이 -- SUBSTR(EMP_NO, 1, 6) YYMMDD
FROM EMPLOYEE;

...
/*
    * 시퀀스 객체 생성
    ...
    [NOCACHE | CACHE]      -> 캐시메모리 할당(기본값 CACHE 200
      > 캐시메모리 : 시퀀스의 값을 미리 생성하여 저장해 두는 곳
                    매번 호출할 때마다 새롭게 번호를 생성하는 게아니라
...
/*
    * 시퀀스 사용
      시퀀스명.CURRVAL : 현재 시퀀스의 값(마지막으로 성공하여 수행된 NEXTVALUE값)
      시퀀스명.NEXTVAL : 시퀀스값에 일정하게 증가시켜서 발생된 값
                       현재시퀀스 값에서 INCREMENT BY 한 값
...
VALUES(SEQ_EID.NEXTVAL,'강감찬','970101-1234567','J3',SYSDATE);
